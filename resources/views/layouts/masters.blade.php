...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('backend/dist/img/logo.png')}}" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: 1">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block" style="font-size:25px; color:white;">{{Auth::user()->name}}</a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">Lawyer</a>.</strong>
    All rights reserved.
